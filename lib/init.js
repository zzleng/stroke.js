(function(){
  ...
  canvas.addEventListener("mousedown", function(e){
    startClick((e.clientX - canvas.offsetLeft), (e.clientY - canvas.offsetTop));
  }, false);
  
  canvas.addEventListener("mousemove", function(e){
    if (clicking) {
      dragClick((e.clientX - canvas.offsetLeft), (e.clientY - canvas.offsetTop));
    }
  }, false);
  
  canvas.addEventListener("mouseup", function(e){
    endClick((e.clientX - canvas.offsetLeft), (e.clientY - canvas.offsetTop));
  }, false);
